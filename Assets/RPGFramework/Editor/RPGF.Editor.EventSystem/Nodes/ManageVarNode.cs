...
{
    [UseActionNode("Управление переменной", contextualMenuPath: "Система/Управление переменной")]
    public class ManageVarNode : ActionNodeBase<ManageVarAction>
    {
        ...
        {
            EnumField varField = new("Тип переменной", ManageVarAction.VarType.Bool);
            ...
            Label lb0 = new("Переменная");
            Label lb1 = new("Значение");
